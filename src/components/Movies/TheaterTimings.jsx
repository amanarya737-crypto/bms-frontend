                    ...
                    next7days.map((date, i) => {
                        ...
                        return (
                            <button
                                ...
                                className={`flex cursor-pointer flex-col border-gray-200
                    items-center px-3 py-2 rounded-lg min-w-[50px] ${isSelected
                                        ? "bg-black text-white font-semibold" : "text-black hover:bg-gray-100"
                                    }`}
                            >
                    ...
                    theatres.map((theatre, i) => (
                        <div key={i}>
                            <div className='flex items-start gap-3 mb-2'>
                                <img src={theatre.img} alt="logo" className='w-8 h-8
                object-contain'/>
                                <div>
                            ...
                            <div className='flex flex-wrap gap-3 ml-11'>
                                {
                                    theatre.timings.map((slot, i) => (
                                        <button key={i} className='border border-gray-300 px-12 py-2
                                         flex flex-col items-center justify-center
                                    rounded-[16px] cursor-pointer text-sm hover:bg-gray-100'>
