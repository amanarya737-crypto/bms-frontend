                ...
                <div className='max-w-6xl mx-auto'>
                    ...
                    {activeTab === "Profile" && (
                            <>
                                ...
                                rounded-t-md px-6 py-6 flex items-center
                                gap-6 text-white'>
                                    <div className='relative w-20 h-20 border-4
                                    border-white rounded-full flex items-center 
                                    justify-center bg-white text-gray-600'>
                                        <IoMdAdd size={24} />
                                    </div>
                                    <div className='mt-2'>
                                        <h2 className='text-2xl font-bold'>Hi, Gangs </h2>
                                ...
                                <div className='bg-white px-6 py-6 rounded-b-md'>
                                    ...
                                    <div className='mb-3 flex items-center justify-between  '>
                                        ...
                                        <div className='flex items-center gap-2'>
                                            ...
                                            <span className='text-green text-xs bg-green-100 
                                            rounded'>Verified</span>
                                        </div>
                                ...
                                <div className='bg-white p-6 mt-4 rounded-md'>
                                    ...
                                    <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                                        <div>
                                            ...
                                            <input type="text" value="Aman Arya" readOnly
                                            className='w-full mt-1 border border-gray-200 rounded-lg
                                            px-3 py-2 ' />
                                        </div>
                                        ...
                                        <div>
                                             ...
                                             <div className='flex gap-2 mt-1'> 
                                                <button
                                                className={`px-4 py-1 border border-gray-200 rounded-lg
                                                bg-white`}
                                                >
                                                    Woman
                                                </button>
